...
import { WhooingResponseArrayModel, WhooingSectionModel } from '../Types';

/**
 * 후잉 유저 정보
 */
export const getWhooingSections = async function (): Promise<WhooingResponseArrayModel<WhooingSectionModel>> {
